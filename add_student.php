...
if(isset($_POST['submit'])){
    ...
    $student_name = $MySQLi_CON->real_escape_string(trim($_POST['student_name']));
    ...
    if($itemRow['student_id'] == $student_id && $itemRow['student_nric'] == $student_nric){
        ...
        $query = $MySQLi_CON->query("INSERT INTO student(student_id, student_name, student_nric, student_course) "
            . "VALUES('$student_id','$student_name','$student_nric','$student_course')");
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <h2 style="text-align:left;"><b>Add New Student</b></h2><br>
                    <ul>
                        <li><p style="text-align:left;">Use the form below add new student.</p></li>
