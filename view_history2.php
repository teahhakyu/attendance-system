                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
							...
							$row_count = $_SESSION['rowCount'];
							// for($x = 1; $x < $row_count; $x++)	{	
								// $subject_name = $_SESSION['subjectName'.$x.''];
								// $subject_session = $_SESSION['subjectSession'.$x.''];
								// $date = $_SESSION['Date'.$x.''];
							// }
							
							if(isset($_GET['date'])&&isset($_GET['subjectName'])&&isset($_GET['subjectSession'])){
								$date = $_GET['date'];
								$subject_name = $_GET['subjectName'];
								$subject_session = $_GET['subjectSession'];
							}
							/* Run query */
							$query = $MySQLi_CON->query("SELECT * FROM attendance WHERE date = '$date' and subject_name = '$subject_name' and subject_session = '$subject_session'");
							/* Number row */
									$i = 1;
...
<!-- Delete data confirmation -->
    <script type="text/javascript">
		...
		window.onload = function() {
		   var getInput1 = localStorage.getItem("storageName1");
		   var getInput2 = localStorage.getItem("storageName2");
		   var getInput3 = localStorage.getItem("storageName3");
		}
