...
if(isset($_POST['submit'])){
    ...
    $query = $MySQLi_CON->query("UPDATE subject SET subject_name = '$subject_name', subject_lecturer = '$subject_lecturer' WHERE id = '$id'");
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
                                <select class="form-control" name="lecturer">
                                    ...
                                    <?php
                                    echo '<option selected value="'.$itemRow['subject_lecturer'].'">'.$itemRow['subject_lecturer'].'</option>';
                                    ?>
                                </select><br>
                            </div>
