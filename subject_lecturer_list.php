    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Subject Lecturer</li>
            </ol>
            <div class="card mb-3">
                                ...
                                if($query->num_rows > 0){
                                    while($subjectRow = $query->fetch_assoc()){
                                        echo ' <tr>
                                                ...
                                                <td>'.$subjectRow['subject_lecturer'].'</td>
                                                <td>'.$subjectRow['subject_session'].'</td>
                                                <td>
                                                <div class="btn-group">
                                                <a href="edit_data.php?id='.$subjectRow['id'].'" class="btn btn-info" role="button" data-toggle="tooltip" data-placement="top" title="Edit Data"><i class="fa fa-fw fa-pencil"></i> Edit</a>
                                                </div>
                                                <div class="btn-group">
    ...
    <script type="text/javascript">
        function delete_id(id){
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        window.location.href='delete_data.php?del='+id;
                    },
                    cancel: function () {
                    }
                }
